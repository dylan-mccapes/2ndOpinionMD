...
export function EohdPage() {
  ...
  if (!isAuthenticated || !isSystemUser) {
    return (
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <h1 className="text-xl font-mono font-bold mb-1" style={{ color: 'var(--text-muted)' }}>
            EoHD MODE
          </h1>
        ...
        >
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
            EoHD requires a system user subscription. Free workflow users retain ASK, CODING, and EoH modes.
          </p>
        </div>
      </div>
    );
