#!/usr/bin/env bash
# NOTE: Pilot uses eoh-llama (8B). Stage A/B num_ctx is OLLAMA_AGENT_NUM_CTX (default 32768).
...
export FORWARD_MKG_COMPRESS_MODEL="${FORWARD_MKG_COMPRESS_MODEL:-eoh-llama}"
