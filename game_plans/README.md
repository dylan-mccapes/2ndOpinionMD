...
| Artifact | Purpose |
|----------|---------|
| `STRATEGY_GRAPH_TRAVERSAL.md` | **Core 12** PTV graph tools for agents (executable via `server/graph_traversal/agent_tools.py`) |
...
| `STRATEGY_*.md` | Historical strategy memos (graph, B2B, EoHD) |
