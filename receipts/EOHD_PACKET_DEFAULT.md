...
This packet is generated for PDF export. It includes the primary detective report followed by each underlying phase report in run order.
...
- **Kind:** patient_facing_explanation
- **Question Type:** E
