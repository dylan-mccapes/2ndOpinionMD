(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ cd 2ndOpinionMD-MVP
-bash: cd: 2ndOpinionMD-MVP: No such file or directory
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ rm -rf .BeatingHeart
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ ./SETUP_BEATING_HEART.sh
========================================
...
Collecting psycopg-binary<3.4,>=3.2.10 (from -r server/requirements.txt (line 73))
  Downloading psycopg_binary-3.3.2-cp312-cp312-macosx_11_0_arm64.whl.metadata (2.7 kB)
...
Downloading psycopg_binary-3.3.2-cp312-cp312-macosx_11_0_arm64.whl (4.7 MB)
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 4.7/4.7 MB 11.0 MB/s  0:00:00
Downloading scikit_learn-1.8.0-cp312-cp312-macosx_12_0_arm64.whl (8.1 MB)
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 8.1/8.1 MB 11.1 MB/s  0:00:00
...
Config: copy .env.example to .pulse or .env and set DATABASE_URL, OPENAI_API_KEY, etc.
  (Optional: server/.pulse or server/.env for overrides; .pulse is loaded before .env)

(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ ./RUN_POSTGRES_APP.sh
...
2026-02-01 14:35:57,579 - root - INFO - Encrypted logging initialized. Log file: ./logs/server.log
2026-02-01 14:36:00,134 - server.api.kg - INFO - kg.py loaded. OPENAI_API_KEY set: yes
2026-02-01 14:36:00,134 - root - INFO - VALYU_API_KEY present: True tail=here
INFO:     Started server process [32839]
INFO:     Waiting for application startup.
2026-02-01 14:36:00,222 - server.api.app_postgres - INFO - Using async DATABASE_URL: postgresql://2ndopinionmd:****@localhost:5432/2ndopinionmd
ERROR:    Traceback (most recent call last):
  ...
  File "/opt/homebrew/Cellar/python@3.12/3.12.12/Frameworks/Python.framework/Versions/3.12/lib/python3.12/contextlib.py", line 210, in __aenter__
    return await anext(self.gen)
           ^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/server/api/app_postgres.py", line 125, in lifespan
    engine = create_async_engine(
             ^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/ext/asyncio/engine.py", line 118, in create_async_engine
    return AsyncEngine(sync_engine)
           ^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/ext/asyncio/engine.py", line 1034, in __init__
...
📚 API documentation available at: http://0.0.0.0:8000/docs
Database connection will be initialized during FastAPI lifespan startup
2026-02-01 14:37:34,067 - root - INFO - Encrypted logging initialized. Log file: ./logs/server.log
2026-02-01 14:37:34,551 - server.api.kg - INFO - kg.py loaded. OPENAI_API_KEY set: yes
2026-02-01 14:37:34,551 - root - INFO - VALYU_API_KEY present: True tail=here
INFO:     Started server process [32945]
INFO:     Waiting for application startup.
2026-02-01 14:37:34,631 - server.api.app_postgres - INFO - Using async DATABASE_URL: postgresql+asyncpg://2ndopinionmd:****@localhost:5432/2ndopinionmd
2026-02-01 14:37:34,647 - server.api.app_postgres - INFO - DB engine disposed
ERROR:    Traceback (most recent call last):
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/starlette/routing.py", line 734, in lifespan
    async with self.lifespan_context(app) as maybe_state:
               ^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/opt/homebrew/Cellar/python@3.12/3.12.12/Frameworks/Python.framework/Versions/3.12/lib/python3.12/contextlib.py", line 210, in __aenter__
    return await anext(self.gen)
           ^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/server/api/app_postgres.py", line 146, in lifespan
    async with engine.connect() as conn:
               ^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/ext/asyncio/base.py", line 125, in __aenter__
    return await self.start(is_ctxmanager=True)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/ext/asyncio/engine.py", line 270, in start
    await greenlet_spawn(self.sync_engine.connect)
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/util/_concurrency_py3k.py", line 200, in greenlet_spawn
    result = context.throw(*sys.exc_info())
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/engine/base.py", line 3269, in connect
    return self._connection_cls(self)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/engine/base.py", line 145, in __init__
    self._dbapi_connection = engine.raw_connection()
                             ^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/engine/base.py", line 3293, in raw_connection
    return self.pool.connect()
           ^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/pool/base.py", line 452, in connect
    return _ConnectionFairy._checkout(self)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/pool/base.py", line 1269, in _checkout
    fairy = _ConnectionRecord.checkout(pool)
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/pool/base.py", line 716, in checkout
    rec = pool._do_get()
          ^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/pool/impl.py", line 169, in _do_get
    with util.safe_reraise():
         ^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/util/langhelpers.py", line 146, in __exit__
    raise exc_value.with_traceback(exc_tb)
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/pool/impl.py", line 167, in _do_get
    return self._create_connection()
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/pool/base.py", line 393, in _create_connection
    return _ConnectionRecord(self)
           ^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/pool/base.py", line 678, in __init__
    self.__connect()
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/pool/base.py", line 902, in __connect
    with util.safe_reraise():
         ^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/util/langhelpers.py", line 146, in __exit__
    raise exc_value.with_traceback(exc_tb)
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/pool/base.py", line 898, in __connect
    self.dbapi_connection = connection = pool._invoke_creator(self)
                                         ^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/engine/create.py", line 645, in connect
    return dialect.connect(*cargs, **cparams)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/engine/default.py", line 616, in connect
    return self.loaded_dbapi.connect(*cargs, **cparams)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/dialects/postgresql/asyncpg.py", line 941, in connect
    await_only(creator_fn(*arg, **kw)),
    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/util/_concurrency_py3k.py", line 130, in await_only
    return current.driver.switch(awaitable)  # type: ignore[no-any-return]
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/sqlalchemy/util/_concurrency_py3k.py", line 195, in greenlet_spawn
    value = await result
            ^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/asyncpg/connection.py", line 2329, in connect
    return await connect_utils._connect(
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/asyncpg/connect_utils.py", line 1017, in _connect
    raise last_error or exceptions.TargetServerAttributeNotMatched(
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/asyncpg/connect_utils.py", line 991, in _connect
    conn = await _connect_addr(
           ^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/asyncpg/connect_utils.py", line 828, in _connect_addr
    return await __connect_addr(params, True, *args)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/asyncpg/connect_utils.py", line 873, in __connect_addr
    tr, pr = await connector
             ^^^^^^^^^^^^^^^
  File "/Users/2ndopinionmd/dev/provenance-engines/PortalVision/2ndOpinionMD-MVP/.BeatingHeart/lib/python3.12/site-packages/asyncpg/connect_utils.py", line 744, in _create_ssl_connection
    tr, pr = await loop.create_connection(
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/opt/homebrew/Cellar/python@3.12/3.12.12/Frameworks/Python.framework/Versions/3.12/lib/python3.12/asyncio/base_events.py", line 1132, in create_connection
    raise exceptions[0]
  File "/opt/homebrew/Cellar/python@3.12/3.12.12/Frameworks/Python.framework/Versions/3.12/lib/python3.12/asyncio/base_events.py", line 1107, in create_connection
    sock = await self._connect_sock(
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/opt/homebrew/Cellar/python@3.12/3.12.12/Frameworks/Python.framework/Versions/3.12/lib/python3.12/asyncio/base_events.py", line 1010, in _connect_sock
    await self.sock_connect(sock, address)
  File "/opt/homebrew/Cellar/python@3.12/3.12.12/Frameworks/Python.framework/Versions/3.12/lib/python3.12/asyncio/selector_events.py", line 651, in sock_connect
    return await fut
           ^^^^^^^^^
  File "/opt/homebrew/Cellar/python@3.12/3.12.12/Frameworks/Python.framework/Versions/3.12/lib/python3.12/asyncio/selector_events.py", line 691, in _sock_connect_cb
    raise OSError(err, f'Connect call failed {address}')
ConnectionRefusedError: [Errno 61] Connect call failed ('::1', 5432, 0, 0)

ERROR:    Application startup failed. Exiting.
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ brew services start postgresql@14
Bootstrap failed: 5: Input/output error
Try re-running the command as root for richer errors.
Error: Failure while executing; `/bin/launchctl bootstrap gui/501 /Users/2ndopinionmd/Library/LaunchAgents/homebrew.mxcl.postgresql@14.plist` exited with 5.
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ # or
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ brew services start postgresql
Bootstrap failed: 5: Input/output error
Try re-running the command as root for richer errors.
Error: Failure while executing; `/bin/launchctl bootstrap gui/501 /Users/2ndopinionmd/Library/LaunchAgents/homebrew.mxcl.postgresql@14.plist` exited with 5.
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ brew services start postgresql@14
...
Try re-running the command as root for richer errors.
Error: Failure while executing; `/bin/launchctl bootstrap gui/501 /Users/2ndopinionmd/Library/LaunchAgents/homebrew.mxcl.postgresql@14.plist` exited with 5.
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ launchctl bootout gui/501 ~/Library/LaunchAgents/homebrew.mxcl.postgresql@14.plist 2>/dev/null
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ brew services start postgresql@14
==> Successfully started `postgresql@14` (label: homebrew.mxcl.postgresql@14)
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ pg_ctl /opt/homebrew/var/postgresql\@14
pg_ctl: unrecognized operation mode "/opt/homebrew/var/postgresql@14"
Try "pg_ctl --help" for more information.
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ # See where postgres@14 lives
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ brew --prefix postgresql@14
/opt/homebrew/opt/postgresql@14
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ # Then (data dir is often that prefix + ../var/postgresql@14)
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ pg_ctl -D /opt/homebrew/var/postgresql@14 start
pg_ctl: another server might be running; trying to start server anyway
waiting for server to start....2026-02-01 14:40:01.011 PST [33951] FATAL:  lock file "postmaster.pid" already exists
2026-02-01 14:40:01.011 PST [33951] HINT:  Is another postmaster (PID 939) running in data directory "/opt/homebrew/var/postgresql@14"?
 stopped waiting
pg_ctl: could not start server
Examine the log output.
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ kill -9 $(lsof -i :5432 -t)
kill: usage: kill [-s sigspec | -n signum | -sigspec] pid | jobspec ... or kill -l [sigspec]
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ pg_ctl -D /opt/homebrew/var/postgresql@14 start
pg_ctl: another server might be running; trying to start server anyway
waiting for server to start....2026-02-01 14:41:27.172 PST [34136] FATAL:  lock file "postmaster.pid" already exists
2026-02-01 14:41:27.172 PST [34136] HINT:  Is another postmaster (PID 939) running in data directory "/opt/homebrew/var/postgresql@14"?
 stopped waiting
pg_ctl: could not start server
Examine the log output.
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ kill -9 $(lsof -i :8000 -t)
kill: usage: kill [-s sigspec | -n signum | -sigspec] pid | jobspec ... or kill -l [sigspec]
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ kill -9 939
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ rm /opt/homebrew/var/postgresql@14/postmaster.pid
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ pg_ctl -D /opt/homebrew/var/postgresql@14 start
waiting for server to start....2026-02-01 14:42:20.998 PST [34179] LOG:  starting PostgreSQL 14.20 (Homebrew) on aarch64-apple-darwin24.6.0, compiled by Apple clang version 17.0.0 (clang-1700.4.4.1), 64-bit
2026-02-01 14:42:20.998 PST [34179] LOG:  listening on IPv6 address "::", port 5432
2026-02-01 14:42:20.998 PST [34179] LOG:  listening on IPv4 address "0.0.0.0", port 5432
2026-02-01 14:42:20.999 PST [34179] LOG:  listening on Unix socket "/tmp/.s.PGSQL.5432"
2026-02-01 14:42:21.012 PST [34180] LOG:  database system was interrupted; last known up at 2026-01-02 12:25:36 PST
2026-02-01 14:42:21.235 PST [34180] LOG:  database system was not properly shut down; automatic recovery in progress
2026-02-01 14:42:21.237 PST [34180] LOG:  redo starts at 3B8/7E836750
2026-02-01 14:42:21.237 PST [34180] LOG:  invalid record length at 3B8/7E836838: wanted 24, got 0
2026-02-01 14:42:21.237 PST [34180] LOG:  redo done at 3B8/7E836800 system usage: CPU: user: 0.00 s, system: 0.00 s, elapsed: 0.00 s
2026-02-01 14:42:21.250 PST [34179] LOG:  database system is ready to accept connections
 done
server started
(.BeatingHeart) www:2ndOpinionMD-MVP 2ndopinionmd$ ./RUN_POSTGRES_APP.sh
🚀 Starting FastAPI application on http://0.0.0.0:8000
📚 API documentation available at: http://0.0.0.0:8000/docs
Database connection will be initialized during FastAPI lifespan startup
2026-02-01 14:42:28,486 - root - INFO - Encrypted logging initialized. Log file: ./logs/server.log
2026-02-01 14:42:28,951 - server.api.kg - INFO - kg.py loaded. OPENAI_API_KEY set: yes
2026-02-01 14:42:28,951 - root - INFO - VALYU_API_KEY present: True tail=here
INFO:     Started server process [34192]
INFO:     Waiting for application startup.
2026-02-01 14:42:29,030 - server.api.app_postgres - INFO - Using async DATABASE_URL: postgresql+asyncpg://2ndopinionmd:****@localhost:5432/2ndopinionmd
2026-02-01 14:42:29,054 - server.api.app_postgres - INFO - Database connection initialized successfully
