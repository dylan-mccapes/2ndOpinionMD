...
def _parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--agent-num-ctx", type=int, default=int(os.environ.get("OLLAMA_AGENT_NUM_CTX", "61440")))
    ap.add_argument("--synth-num-ctx", type=int, default=int(os.environ.get("OLLAMA_SYNTH_NUM_CTX", "61440")))
    ...
    ap.add_argument("--mkg-compress-num-ctx", type=int, default=int(os.environ.get("OLLAMA_COMPRESS_NUM_CTX", "61440")))
    ap.add_argument("--mkg-compress-evidence-k", type=int, default=8)
    ap.add_argument("--mkg-synth-num-ctx", type=int, default=int(os.environ.get("OLLAMA_SYNTH_NUM_CTX", "61440")))
