# server/api/rag_stream_ask.py — ASK and CODING stream modes
# Part of the 4-module split of rag_stream_custom_endpoints.py.
# Covers: ask_stream_event_generator, ask_stream route,
#          coding_stream_event_generator, coding_stream route,
