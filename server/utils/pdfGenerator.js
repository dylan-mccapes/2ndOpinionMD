...
/**
 * Formats a symptom name from snake_case to Title Case
 * @param {string} symptom - Symptom name in snake_case
...
/**
 * Gets color for confidence score
 ...
 * @returns {Promise} - Promise that resolves with the PDF document
 */
const generatePdfReport = async (diagnosticResults) => {
 ...
 */
const downloadPdfReport = async (diagnosticResults, filename = 'medical-report.pdf') => {
  try {
