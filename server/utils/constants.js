...
exports.POSSIBLE_DIAGNOSES = [
  ...
  },
  {
    ...
    confidence: 70,
    symptoms: ['fatigue', 'weight_gain', 'cold_intolerance', 'hair_loss', 'brain_fog'],
    redFlags: ['Enlarged thyroid (goiter)', 'Family history of thyroid disorders'],
    labSuggestions: ['TSH', 'Free T4', 'Thyroid antibodies', 'Thyroid ultrasound']
  },
  {
    name: 'Psoriatic Arthritis',
    confidence: 62,
    symptoms: ['joint_pain', 'skin_lesions', 'nail_changes', 'fatigue'],
    redFlags: ['Psoriasis skin lesions', 'Nail pitting or separation'],
    labSuggestions: ['Joint X-rays', 'CRP', 'ESR', 'Rheumatoid factor (often negative)']
  },
  {
    name: 'Ankylosing Spondylitis',
    confidence: 55,
    symptoms: ['back_pain', 'stiffness', 'fatigue', 'reduced_mobility'],
    redFlags: ['Pain improves with exercise', 'Morning stiffness', 'Family history'],
    labSuggestions: ['HLA-B27 genetic test', 'X-rays of spine and pelvis', 'MRI of sacroiliac joints']
  },
  {
    name: 'Fibromyalgia',
    confidence: 60,
    symptoms: ['widespread_pain', 'fatigue', 'sleep_disturbances', 'brain_fog'],
    redFlags: ['Multiple tender points', 'Non-restorative sleep'],
    labSuggestions: ['Tests to rule out other conditions', 'Sleep study']
  },
  {
    name: 'Chronic Fatigue Syndrome (ME/CFS)',
    confidence: 58,
    symptoms: ['fatigue', 'post_exertional_malaise', 'sleep_disturbances', 'brain_fog'],
    redFlags: ['Severe fatigue not improved by rest', 'Post-exertional malaise'],
    labSuggestions: ['Tests to rule out other conditions', 'Viral panel']
  }
];
